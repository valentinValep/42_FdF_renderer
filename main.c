...
int	main(void)
{
	...
	draw_line(&renderer, (t_point){-400, 400, 300, 0x00FFFFFF}, (t_point){-300, 300, 300, 0x00FF0000});
	draw_line(&renderer, (t_point){-300, 300, 300, 0x00FF0000}, (t_point){-200, 200, 300, 0x00FF00FF});
	draw_line(&renderer, (t_point){-200, 200, 300, 0x00FF00FF}, (t_point){-100, 100, 300, 0x00FFFF00});
	draw_line(&renderer, (t_point){-100, 100, 300, 0x00FFFF00}, (t_point){0, 0, 300, 0x0000FF00});
